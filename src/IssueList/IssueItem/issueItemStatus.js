...
const IssueItemStatus = ({ status }) => {
    return (
        <div className="issue-item-status float-left pt-2 pl-3">
            <span className="tooltipped tooltipped-n" aria-label="Open issue">
                <svg className={"octicon octicon-issue-opened " + status } viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true">
